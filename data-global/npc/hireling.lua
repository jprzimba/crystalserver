		...
		elseif npcHandler:getTopic(playerId) == TOPIC.SERVICES then
			...
			elseif MsgContains(message, "goods") then
				...
				if not hireling:hasSkill(HIRELING_SKILLS.TRADER[2]) then
					...
					string = "I sell a selection of {various} items, {exercise weapons}, {equipment}, " .. "{distance} weapons, {wands} and {rods}, {potions}, {runes}, " .. "{supplies}, {tools} and {postal} goods and also I sell {imbuement packages} and also I can {buy loot}. Just ask!"
				end
